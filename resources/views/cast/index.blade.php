        ...
        <div class="row g-2 align-items-center">
          ...
          <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
              ...
              <a href="{{ route('casts.create') }}" class="btn btn-primary d-sm-none btn-icon"
          ...
          <div class="card-body">
            <div id="table-default" class="table-responsive">
              <table class="table" id="cast-table">
                  ...
                  <tr>
                    ...
                    <td class="sort-avatar">
                      @if (optional($cast)->avatar)
                        <img src="{{ asset('storage/' . optional($cast)->avatar) }}" alt="Avatar"
                ...
                @empty
                  <tr>
                    <td colspan="5" class="text-center">Tidak ada data pemeran yang ditemukan.</td>
                  </tr>
                @endforelse
                </tbody>
              </table>
